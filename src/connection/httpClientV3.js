...
import {getData, removeData, setEventAdminVerified} from '../utils/Storage';
import {NavigationService} from '../utils/NavigationService';
import messaging from '@react-native-firebase/messaging';

const httpClientV3 = axios.create({
  baseURL: Config.API_HOST2,
  headers: {
    Accept: '*',
...
httpClientV3.interceptors.request.use(
  async config => {
...
httpClientV3.interceptors.response.use(
  async response => {
